...
src="https://connect.facebook.net/th_TH/sdk.js#xfbml=1&version=v13.0" 
nonce="SHE8kfzc"></script>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
            ...
            <table class="w-full text-md rounded mb-4">
                ...
                @foreach(auth()->user()->tasks as $task)
                    ...
                    data-href="https://www.facebook.com/nongpurenatnicha" 
                    data-layout="button" 
                    data-size="small"><a target="_blank" 
                    href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.facebook.com%2Fnongpurenatnicha&amp;src=sdkpreparse" 
